...
def get_DataLoader(args):
    if args.dataset == 'food101':
        ...
        if args.multi_task: # Multi-task multi-label for categories and ingredients
            # pdb.set_trace()
            image_size = 224
            ...
            # Category labels and ingredient labels are in different txt files for food101, while they are in the same file for food172
        ...
        else: # Single task classification, single label
        ...
        print('For food172, refer to /home/isia/lmj/20210303/Experiment/code_new_wzlmm/dataset172.py implementation;\
        Image paths, category labels, and ingredients are all in /home/isia/lmj/20210303/Experiment/data/food172/retrieval_dict/train_full_processed.txt')
